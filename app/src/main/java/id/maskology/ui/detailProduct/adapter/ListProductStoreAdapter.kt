package id.maskology.ui.detailProduct.adapter
...
class ListProductStoreAdapter :
    PagingDataAdapter<Product, ListProductStoreAdapter.ListViewHolder>(DIFF_CALLBACK)
{
    override fun onBindViewHolder(holder: ListProductStoreAdapter.ListViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ListProductStoreAdapter.ListViewHolder {
